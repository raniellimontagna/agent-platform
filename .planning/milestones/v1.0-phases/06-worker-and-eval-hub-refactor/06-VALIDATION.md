...
| 06-02-W0 | 02 | 0 | REF-04, VER-01 | T-06-codegen-regression | Prompt, JSON, file, selection, and fix helpers are characterized before movement. | unit/characterization | `rtk corepack pnpm vitest run apps/worker-code/src/executor/codegenJson.test.ts apps/worker-code/src/executor/codegenFiles.test.ts apps/worker-code/src/executor/codegenSelection.test.ts apps/worker-code/src/executor/codegenFixes.test.ts` | No - W0 | pending |
| 06-02-01 | 02 | 1 | REF-04 | T-06-codegen-regression | Prompt and JSON helper extraction preserves prompt text, model alias, JSON mode, repair, parse behavior, and usage accounting. | unit + typecheck | `rtk corepack pnpm vitest run apps/worker-code/src/executor/codegen.test.ts apps/worker-code/src/executor/codegenJson.test.ts && rtk corepack pnpm --filter @agent-platform/worker-code typecheck` | No - W0 | pending |
| 06-02-02 | 02 | 1 | REF-04 | T-06-codegen-regression | File, selection, and fix helpers preserve safe path handling, generated marker behavior, selected files, and self-correction inputs. | unit + typecheck | `rtk corepack pnpm vitest run apps/worker-code/src/executor/codegen.test.ts apps/worker-code/src/executor/codegenFiles.test.ts apps/worker-code/src/executor/codegenSelection.test.ts apps/worker-code/src/executor/codegenFixes.test.ts apps/worker-code/src/eval/workerDryRun.test.ts && rtk corepack pnpm --filter @agent-platform/worker-code typecheck` | No - W0 | pending |
| 06-03-W0 | 03 | 0 | REF-05, VER-01 | T-06-eval-regression | Eval scenario loading, scenario execution, report text, trends, and harness checks are characterized before extraction. | unit/characterization | `rtk corepack pnpm vitest run apps/worker-code/src/eval/scenarioLoader.test.ts apps/worker-code/src/eval/scenarioRunner.test.ts apps/worker-code/src/eval/reportRenderer.test.ts apps/worker-code/src/eval/trend.test.ts apps/worker-code/src/eval/harnessChecks.test.ts` | No - W0 | pending |
| 06-03-01 | 03 | 1 | REF-05 | T-06-eval-regression | Loader and scenario runner helpers preserve runtime orchestration, candidate command behavior, and scenario result shape. | unit + typecheck | `rtk corepack pnpm vitest run apps/worker-code/src/eval/runEval.test.ts apps/worker-code/src/eval/scenarioLoader.test.ts apps/worker-code/src/eval/scenarioRunner.test.ts apps/worker-code/src/eval/workerDryRun.test.ts && rtk corepack pnpm --filter @agent-platform/worker-code typecheck` | No - W0 | pending |
| 06-03-02 | 03 | 1 | REF-05 | T-06-eval-regression | Report renderer, trend, and harness helpers preserve report artifacts, check names, thresholds, and role quality semantics. | unit + typecheck | `rtk corepack pnpm vitest run apps/worker-code/src/eval/runEval.test.ts apps/worker-code/src/eval/scoring.test.ts apps/worker-code/src/eval/workerDryRun.test.ts apps/worker-code/src/eval/roleQuality.test.ts apps/worker-code/src/eval/scenarioLoader.test.ts apps/worker-code/src/eval/scenarioRunner.test.ts apps/worker-code/src/eval/reportRenderer.test.ts apps/worker-code/src/eval/trend.test.ts apps/worker-code/src/eval/harnessChecks.test.ts && rtk corepack pnpm --filter @agent-platform/worker-code typecheck` | No - W0 | pending |
| 06-04-W0 | 04 | 0 | REF-06, VER-01 | T-06-research-regression | Research output formatting, redaction, section names, limitation wording, and Instagram URL helpers are characterized before extraction. | unit/characterization | `rtk corepack pnpm vitest run apps/worker-code/src/executor/researchOutput.test.ts` | No - W0 | pending |
| 06-04-01 | 04 | 1 | REF-06 | T-06-research-regression | Shared research helpers preserve provider policy, redaction, section names, limitation wording, and output truncation. | unit + focused provider tests | `rtk corepack pnpm vitest run apps/worker-code/src/executor/researchOutput.test.ts apps/worker-code/src/executor/firecrawlResearch.test.ts apps/worker-code/src/executor/playwrightResearch.test.ts apps/worker-code/src/executor/instagramGraphResearch.test.ts apps/worker-code/src/executor/apifyInstagramResearch.test.ts && rtk corepack pnpm --filter @agent-platform/worker-code typecheck` | No - W0 | pending |
| 06-04-GATE | 04 | gate | REF-03, REF-04, REF-05, REF-06, VER-01 | T-06-phase-regression | Full repo verification remains green after all worker/eval extractions. | full suite | `rtk corepack pnpm verify` | Yes | pending |
...
- [ ] `apps/worker-code/src/eval/scenarioRunner.test.ts` - guards scenario execution and runtime orchestration after extraction.
