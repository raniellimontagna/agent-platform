...
- **After Wave 2:** Run both webhook and Mission Control quick commands.
- **Before phase verification:** Run `rtk corepack pnpm verify` in Plan 05-03.
