...
- `feat/mac-X-descricao` — nova funcionalidade
- `fix/mac-X-descricao` — correção de bug
- `chore/mac-X-descricao` — tarefas de infra/config
- `docs/mac-X-descricao` — documentação
- `refactor/mac-X-descricao` — refatoração sem mudança de comportamento
- `test/mac-X-descricao` — testes
